...
<body class="bg-gray-50 text-[#333333]">
    ...
    {{-- 2. The Main Content --}}
    <main>
        {{-- Hero Section Included via Partial --}}
        ...
        <header class="relative w-full bg-cover bg-[center_top] bg-no-repeat min-h-[500px] md:min-h-[1000px] flex flex-col"
            ...
            <div class="absolute bottom-0 left-0 w-full h-[350px] bg-gradient-to-t from-white via-white/80 to-transparent z-10"></div>
            ...
            <div class="container mx-auto px-4 relative z-20 flex-grow flex flex-col justify-between pb-20 pt-32 md:pt-48">
                ...
                <div class="mt-20">
                    ...
                    <div class="flex justify-center mt-12">
                        <a href="/path-ke-halaman-list-layanan"
                            class="inline-flex items-center px-6 py-3 text-base font-semibold text-white bg-blue-600 rounded-lg shadow-md hover:bg-blue-700 transition-colors duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                            Selengkapnya
